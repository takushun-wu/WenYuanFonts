...
- 对字体文件进行修改、扩充和格式转换，但如果您要发表二次修改的作品，**必须满足如下条件**：
    - **以SIL Open Font License的授权形式**发表，同时**不得使用本字体的保留名称（以及它的其他语言的翻译形式）：WenYuan Sans、<span lang="zh-Hans">文源黑体</span>、WenYuan Serif、<span lang="zh-Hans">文源宋体</span>、WenYuan Rounded、<span lang="zh-Hans">文源圆体</span>**（若仅对源字体进行格式转换，或子集化，且不将更改后的字体文件单独发布可继续使用该保留名称）；
